        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            <h2 className="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
              <TrendingUp size={15} className="text-green-600"/> Productos más vendidos
            </h2>
                  ...
                  <div key={nombre} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 bg-gray-100 rounded-full h-1.5 overflow-hidden">
                      <div className="bg-green-500 h-full rounded-full"
                        style={{ width: `${(cant / topProductos[0][1]) * 100}%` }}/>
                    </div>
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            <h2 className="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
              <Package size={15} className="text-amber-500"/> Sin movimiento
            </h2>
              ...
              <div className="space-y-1">
                {sinMovimiento.slice(0,5).map(p => (
                  <div key={p.id} className="flex items-center gap-2 text-sm">
                    ...
                    <span className="ml-auto text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full font-medium">{p.stock} uds</span>
                  </div>
                ))}
              </div>
            )}
